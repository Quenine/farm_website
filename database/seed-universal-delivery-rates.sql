-- Repeat-safe universal product delivery rates for Noble Farms / Shields Farms.
-- Run separately on each farm Supabase project after product seeds/normalization.
