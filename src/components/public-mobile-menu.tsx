...
export function PublicMobileMenu() {
  ...
  useEffect(()=>{if(previousPathname.current!==pathname){previousPathname.current=pathname;setOpen(false)}},[pathname]);
