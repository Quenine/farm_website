...
function RunButton() {
  ...
  return (
    ...
    >
      {pending ? "Running paid discovery…" : "Confirm and run paid DataForSEO discovery"}
    </button>
  );
}
  ...
  return (
    <form action={action}>
      ...
      <label className="mt-3 flex gap-2">
        ...
        <span>I understand this may incur a DataForSEO charge and sends no outreach.</span>
      </label>
