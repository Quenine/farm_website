...
export function OutreachControls({
  ...
  const [contactReviewed, setContactReviewed] = useState(false);
  ...
  const [draft, setDraft] = useState(currentDraft?.draft_text ?? generated);
  ...
  return <section className="space-y-4 rounded-xl border bg-white p-5">
    ...
    {approved ? <div className="rounded border border-amber-300 bg-amber-50 p-4">
      ...
      <p className="mt-2 text-sm">
        Copy the approved text for social profiles or a phone call. You must press Send or place the call yourself.
      </p>
