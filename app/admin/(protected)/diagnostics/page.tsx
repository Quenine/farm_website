...
export default async function AdminDiagnosticsPage() {
  ...
  const diagnostics = [
    ...
    { label: "Official Next.js Google component", value: "Enabled", isSecret: false },
    { label: "Google measurement prefix valid", value: google.type === "google_tag" && "prefix" in google && google.prefix === "G" ? "Ready" : "Misconfigured", isSecret: false },
    { label: "GTM variable empty", value: process.env.NEXT_PUBLIC_GTM_CONTAINER_ID?.trim() ? "Conflict" : "Ready", isSecret: false },
    { label: "Legacy GA variable empty", value: process.env.NEXT_PUBLIC_GA_MEASUREMENT_ID?.trim() ? "Conflict" : "Ready", isSecret: false },
    { label: "Analytics consent required", value: "Yes", isSecret: false },
    { label: "Analytics test route", value: marketingConfig.analyticsTestEnabled ? "Temporarily enabled" : "Disabled", isSecret: false },
