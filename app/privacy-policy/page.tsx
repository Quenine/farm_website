    ...
    <PageShell>
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        <SectionHeader
          ...
          body="Noble Farms collects only the information needed to process orders, accept payment, arrange fulfilment, and support customers."
        />
        <div className="mt-8 grid gap-5 rounded-lg bg-white p-6 text-sm leading-7 text-stone-700 shadow-sm">
          ...
          <p>Payment is processed through Paystack. Noble Farms does not store card details on this website.</p>
          ...
          <p>For privacy questions, contact info@noblefarms.xyz.</p>
        </div>
      </section>
    </PageShell>
  );
