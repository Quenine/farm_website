...
- Added repeat-safe migration `database/20260730000100_sales_scout_review_workflow.sql`.
...
- Sales Scout checks: 23 passed; marketing checks, scoped ESLint, TypeScript,
...
- SQL behavioural verification remains a human-run non-production/rollback step.
