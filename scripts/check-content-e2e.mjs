...
check("Image upload opens panel and retains selected file", editor.includes("Insert Image") && editor.includes("Selected file:") && editor.includes("uploadFile.name"));
...
check("Markdown image insertion is well formed", editor.includes('result.media.url') && editor.includes('uploadAlt.trim()') && editor.includes('caption ?') && editor.includes('insert(`!['));
